...
以下周报为第三期第二月优秀周报，按学习周次归档。同一周有多份周报时使用编号区分。

| 周次 | 编号 | 周报 | 主要阶段 |
| :--- | :---: | :---: | :--- |
| 第二月第 1 周 | 1 | [查看优秀周报](https://jcn2idptsy3u.feishu.cn/wiki/EsLrwDzHViQ07qkndzGcbqKqnQc?from=from_copylink) | 熟悉 MotrixLab 平台并跑通基础任务 |
| 第二月第 2 周 | 1 | [查看优秀周报](https://jcn2idptsy3u.feishu.cn/wiki/L44BwyCbriq8fWkVu8fcvvntnVf?from=from_copylink) | 理解任务结构、奖励机制与参数影响 |
| 第二月第 2 周 | 2 | [查看优秀周报](https://zcnc3psjghb0.feishu.cn/wiki/LrgbwBDc1iiL64k2x6tc77vrnMd?from=from_copylink) | 理解任务结构、奖励机制与参数影响 |
| 第二月第 3 周 | 1 | [查看优秀周报](https://jcn2idptsy3u.feishu.cn/wiki/ByTswzVPjiUD0EkBvwtcgq9Fnud?from=from_copylink) | 搭建任务框架与核心方法 |
| 第二月第 3 周 | 2 | [查看优秀周报](https://mcnhqppf3zvp.feishu.cn/wiki/ADpYwcXbPia75BkUrMbcm0m5nTd?from=from_copylink) | 搭建任务框架与核心方法 |
| 第二月第 4 周 | 1 | [查看优秀周报](https://zcnrmo4riqxk.feishu.cn/wiki/SwszwtcYTieFbnkA8rtcFexundf?from=from_copylink) | 完整调试、训练与结果复现 |
| 第二月第 4 周 | 2 | [Xbotics 实习第二月第四周](https://bcnm5rfcf0j6.feishu.cn/wiki/HftQw5fxHi3AoPkQO88c6Thkn3b) | 完整调试、训练与结果复现 |
| 第二月第 4 周 | 3 | [查看优秀周报](https://tcncarme1ex9.feishu.cn/docx/VQ7PdSPEHo8ujLxham7cqgjInKc) | 完整调试、训练与结果复现 |

> [!NOTE]
> 周报作者及具体任务名称将在获得可读取的文档信息后补充。
