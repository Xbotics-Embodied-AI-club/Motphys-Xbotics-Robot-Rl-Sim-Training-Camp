...
| 类型 | 示例 | 放哪里 |
|:---:|:----:|:-----:|
| 参数值 | episode 长度从 20 改成 30 | ✅ EnvCfg |
| 奖励权重 | 某 reward 项权重从 1.0 改成 0.2 | ✅ EnvCfg |
| 路径配置 | 模型文件路径 | ✅ EnvCfg |
| 时间步长 | sim_dt、ctrl_dt | ✅ EnvCfg |

### 2.4 EnvCfg 不适合放什么？

| 类型 | 示例 | 放哪里 |
|:---:|:----:|:-----:|
| 动作转换逻辑 | 动作如何转换成关节控制 | ❌ 放 Env |
| 奖励计算公式 | 某 reward 项如何根据状态计算 | ❌ 放 Reward |
