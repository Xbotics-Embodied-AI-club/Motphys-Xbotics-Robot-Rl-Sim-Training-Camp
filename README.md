...
- **阅读入口**：
  ...
  - 第四期：[第四期实训营（强化学习与 MotrixLab 入门课程）](./docs/强化学习与MotrixLab入门/index.md)
  - 结营作业：
...
- [第四期实训营（强化学习与 MotrixLab 入门课程）](./docs/强化学习与MotrixLab入门/index.md)：整理强化学习基础课程与 MotrixLab 入门精品课程，覆盖平台架构、训练环境、奖励函数、配置/注册系统、训练流程和 Demo 分析方法。
